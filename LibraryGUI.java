    ...
    void issueBook() {
        ...
        for (Book b : books) {
            if (b.id == id) {
                ...
                b.isIssued = true;
                b.studentName = name;
                b.enrollment = en == null ? "" : en;
                b.contact = ph == null ? "" : ph;
